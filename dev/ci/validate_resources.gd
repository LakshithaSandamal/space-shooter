...
const RESOURCES: PackedStringArray = [
	...
	"res://scenes/power_ups/core_power_up.tscn",
	"res://scenes/systems/wave_spawner.tscn",
	"res://scenes/systems/skill_system.tscn",
	"res://scenes/systems/power_up_system.tscn",
	"res://scenes/effects/skill_feedback_emitter.tscn",
	"res://scenes/effects/power_up_feedback_emitter.tscn",
